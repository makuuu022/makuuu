...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['email'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $stmt = $conn->prepare("UPDATE admins SET reset_token=?, reset_expires=DATE_ADD(NOW(), INTERVAL 1 HOUR) WHERE email=?");
            ...
            $resetLink = "http://localhost/final/createnewpassadmin.php?token=" . urlencode($token);
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('jadesupremo0@gmail.com', 'Concepcion Balagtas Dichoso Lying Maternity Clinic');
